...
public class SpringSecurityConfig {
    ...
    protected SecurityFilterChain filter (HttpSecurity http) throws Exception{
        ...
        http
                ...
                .requestMatchers(HttpMethod.PUT, "/stocks").permitAll()
                .requestMatchers(HttpMethod.DELETE, "/stocks/{id}").permitAll()
                .requestMatchers(HttpMethod.PUT, "/stocks/{id}").permitAll()
